...
<body>
    ...
    <div class="container-sm mt-5">
        <form action="<?php echo e(route('employees.store')); ?>" class="needs-validation was-validated" method="POST"
            novalidate="">
            <?php echo csrf_field(); ?>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input class="form-control" type="text" name="firstName" id="firstName"
                                ...
                                class="<?php $__errorArgs = ['firstName'];
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input class="form-control" type="text" name="lastName" id="lastName"
                                value="<?php echo e(old('lastName')); ?>" placeholder="Enter Last Name" required="">
...
<?php /**PATH D:\FemWokPurp\PrakMod04\resources\views/employee/create.blade.php ENDPATH**/ ?>